...
public class UStringValue extends UncertainValue {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof Value) {
            ...
            if (ustring != null)
                eq = wrapper.getString().equals(ustring.wrapper.getString()) &&
                        wrapper.getsConf() == ustring.wrapper.getsConf();
    ...
    public int compareTo(Value o) {
        ...
        if (o instanceof UndefinedValue )
            return +1;
        if (! (o instanceof StringValue || o instanceof UStringValue) )
            return toString().compareTo(o.toString());

        return wrapper.getString().compareTo(valueOf(o).value());
    }
