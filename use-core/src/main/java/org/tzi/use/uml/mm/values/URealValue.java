...
public class URealValue extends UncertainValue {
    ...
    public int compareTo(Value o) {
        ...
        if (o instanceof URealValue)
            ...
            URealValue uRealVal = (URealValue) o;
            res = uRealVal.compareTo(new UIntegerValue((int) uRealVal.value(), uRealVal.uncertainty()));
        }
    ...
    /**
     * Compare a UReal value with another.
     *
    ...
    private URealValue assertKindOfUReal(Value value) {
        URealValue uRealVal = valueOf(value);
